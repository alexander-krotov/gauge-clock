...
humidity) and a BMP280 (temperature/pressure) sensor, all over I2C.
...
- `VoltmeterDisplay` wraps the MCP4728 DAC. `set_range()` defines the input value's low/high bounds per
